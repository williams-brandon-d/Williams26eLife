%% motion correction for TICO voltage imaging data using NORMCore
...
dataPath = 'D:\chr2-voltron-27\s4\20240314-203300'; % example
...
disp('Loading RAW file as stack...')
[Y, recordingInfo] = readKinetixRaw(fileInfo, depth);
disp('Done.')

averageFrame = double(mean(Y(:,:,1000:1050), 3)); % take an average frame
...
% tifname = [dataPath filesep foldername '.tif'];
% fprintf('Writing RAW file to TIF: %s',tifname);
% tic;
% writeTiff(stack,tifname);
% toc;
% disp('Done writing TIF file.');
