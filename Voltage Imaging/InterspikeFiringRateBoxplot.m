...
for iFreq = 1:nFreqs
    ...
    for iFolder = 1:nFolders
        ...
        allFRs = getFRs(spikes,lfp); % nNeurons x 1 cell

        data{iFolder,iFreq} = cell2mat(allFRs);
...
y.labelstring = 'Interspike Firing Rates (Hz)';
y.scale = 'linear';
...
if savenum
    saveFilename = [savePath filesep 'Interspike Firing Rate Boxplot.svg'];
